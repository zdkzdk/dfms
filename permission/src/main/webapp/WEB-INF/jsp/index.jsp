...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="<%=path %>/node_modules/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="<%=path %>/node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <link rel="stylesheet" href="<%=path %>/node_modules/jquery-bar-rating/dist/themes/css-stars.css">
    <link rel="stylesheet" href="<%=path %>/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />
...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="index.html"><img src="<%=path %>/images/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<%=path %>/images/logo-mini.svg" alt="logo"/></a>
        </div>
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <div class="search-field ml-4 d-none d-md-block"><%=path %>
        ...
        <div class="row row-offcanvas row-offcanvas-right">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">用户列表</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/permission/list">
                            <span class="menu-title">权限(菜单)管理</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 pr-1">
                                        <img src="<%=path %>/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                    <div class="col-6 pl-1">
                                        <img src="<%=path %>/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="<%=path %>/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                </div>
                                <div class="d-flex mt-5 align-items-top">
                                    <img src="<%=path %>/images/faces/face3.jpg" class="img-sm rounded-circle mr-3" alt="image">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <img src="<%=path %>/images/faces/face1.jpg" class="mr-2" alt="image">
                                                David Grey
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <img src="<%=path %>/images/faces/face2.jpg" class="mr-2" alt="image">
                                                Stella Johnson
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <img src="<%=path %>/images/faces/face3.jpg" class="mr-2" alt="image">
                                                Marina Michel
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <img src="<%=path %>/images/faces/face4.jpg" class="mr-2" alt="image">
                                                John Doe
                                            </td>
                                            <td>
                                                <label class="badge badge-gradient-success">DONE</label>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2017 Bootstrap Dash. All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></span>
...
<script src="<%=path %>/node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js"></script>
<!-- endinject -->
<!-- Plugin js for this page-->
<script src="<%=path %>/node_modules/chart.js/dist/Chart.min.js"></script>
<!-- End plugin js for this page-->
<!-- inject:js -->
<script src="<%=path %>/js/off-canvas.js"></script>
<script src="<%=path %>/js/misc.js"></script>
<!-- endinject -->
