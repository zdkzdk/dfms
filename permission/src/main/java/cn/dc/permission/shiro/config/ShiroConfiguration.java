package cn.dc.permission.shiro.config;




import cn.dc.permission.shiro.matcher.CredentialsMatcher;
import cn.dc.permission.shiro.realm.AuthRealm;
import cn.dc.permission.shiro.sessionManager.CustomSessionManager;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager) {
       ...
       filterChainDefinitionMap.put("/admin/*", "anon");//表示需要认证才可以访问
